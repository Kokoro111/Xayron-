...
const projects = [
  {
    ...
    materials: [
      { title: 'FILA 山猫鞋', src: 'https://www.xinpianchang.com/a12933819?from=UserProfile', kind: 'external', poster: 'https://images.unsplash.com/photo-1531058020387-3be344556be6?auto=format&fit=crop&w=1200&q=85' },
...
function ProjectCover({ project, slide }) {
  ...
  const renderCover = (cover, transitionClass) => {
    ...
    return <img className={`project-cover ${transitionClass}`} key={`${cover.coverKey}-${transitionClass}`} src={cover.poster ?? cover.src ?? project.image} alt="" />
  }
